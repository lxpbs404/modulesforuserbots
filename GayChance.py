...
__version__ = (1,0,0)
@loader.tds
class GayChance(loader.Module):
    """Показывает насколько процентов ты гей"""
    strings = {
        "name": "GayChance",
    }
    def gaychance_core(self, message):
        ...
        return (
            f'<i>Шанс того что ты гей:</i> <b>{rand.choice(gaychance_core)}</b>'
        )
    @loader.command()
